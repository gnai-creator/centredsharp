...
internal class Perlin
{
    ...
    public float Fractal(float x, float y, float roughness, int octaves = 6, float baseFrequency = 1.5f)
    {
        float total = 0;
        float amplitude = 1;
        float frequency = baseFrequency; // Frequência base pode ser ajustada
        float max = 0;
